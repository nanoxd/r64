...
impl From<u32> for RegStatus {
    fn from(value: u32) -> Self {
        RegStatus {
            ...
            kernel_mode_64bit_addressing_enable: (value & (1 << 7)) != 0,
            supervisor_mode_64bit_addressing_enable: (value & (1 << 6)) != 0,
            user_mode_64bit_addressing_enable: (value & (1 << 5)) != 0,

            mode: value.into(),

            error_level_enable:     (value & (1 << 2)) != 0,
            exception_level_enable: (value & (1 << 1)) != 0,
